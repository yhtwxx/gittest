...
<div id=DataTR style="display:none;" >
	<xmp>
	<c:choose>
   	 <c:when test="${rtype == 'r'||rtype == 'ft_r'|| rtype == 'p3'}">
     <!--SHOW LEGUAGE START-->
     <tr *ST* >
  ...
  <tr id="TR_*ID_STR*" *TR_EVENT* *CLASS*>
    ...
    <td rowspan="2" class="b_cen tn_w">*NODATA*
    	<table class="rb_box_vb" *NOWSERVER*>
	    	<tr class="rb_time"><td class="bm_td"></td><td class="rb_tn_f">局</td><td class="rb_tn_f">分</td></tr>
	    	<tr class="rb_tn_tr"><td *NOWH*></td><td>*SETH*</td><td class="vb_pcolor">*POINTH*</td></tr>
	    	<tr class="rb_tn_tr"><td *NOWC*></td><td>*SETC*</td><td class="vb_pcolor">*POINTC*</td></tr>
    	</table>
    </td>    
