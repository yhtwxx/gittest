...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0">
  	<frame name="body_var" scrolling="NO" noresize src="../body_var.do?rtype=${rtype }&langx=${langx }&mtype=${mtype }&g_date=${g_date }&page_no=0&league_id=${league_id }&hot_game=${hot_game }&ftype=BM&showtype=browse">	
