...
<body id="MBM" class="bodyset ${tatype }" onLoad="onLoad();">
                  							...
                  							<table border="0" cellspacing="0" cellpadding="0" class="tool_box">
                    							<tr>
					                        		...
					                        		<td id="fav_btn">
                            							...
                            							<div id="showAll" title="所有赛事" onClick="showAllGame('BM');" style="display:none;" class="fav_on"></div>
                            							<div id="showMy" title="我的最爱" onClick="showMyLove('BM');" class="fav_out"></div>
                        							</td>
                    								</c:if>
