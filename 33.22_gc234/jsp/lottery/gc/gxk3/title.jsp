...
<div class="caihead">
    <h2>广西快3</h2>
    <a href="javascript:;" class="sg"  onclick="parent.openStaticPopup('gxk3')" >开奖结果</a>
...
<div class="caiplay">
	<ul id="caiplaynav" class="nav nav-pills" role="tablist">
		<li role="presentation" class="active"><a data-type="gxk3" data-flag="zhupan" href="javascript:void(0);" >主盘势</a></li>
		<li role="presentation"><a data-type="gxk3" data-flag="qita" href="javascript:void(0);" >其他</a></li>
	</ul> <!-- /pills -->
</div>
