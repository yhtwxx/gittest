...
<script src="${ctx }/js/lottery/ahk3/member_common_ahk3.js"></script>
	
<script>
    //循环输出
    $.ajax({url: "${ctx }/ahk3/itemDate.do?timeStamp=" + new Date().getTime()+"+&Pid=3,4,5,6,7",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
