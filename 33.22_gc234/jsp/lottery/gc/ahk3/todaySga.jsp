...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var html="";
	var ahk3 = ["","${ctx}/img/lottery/dice_01.png","${ctx}/img/lottery/dice_02.png","${ctx}/img/lottery/dice_03.png","${ctx}/img/lottery/dice_04.png","${ctx}/img/lottery/dice_05.png","${ctx}/img/lottery/dice_06.png"];
...
<script>
    ...
    //循环输出
    $.ajax({url: "${ctx}/ahk3/todaySg.do?timeStamp=" + new Date().getTime()+"+&resultDate="+date,type: "get",dataType: "json",
    success: function(b) {
    if(0 == b.code){
