...
<script src="${ctx}/js/lottery/hnsf/member_common_hnsf.js"></script>
<script>
    $(function() {
        //循环输出
        $.ajax({url: "${ctx}/hnsf/itemDate.do?timeStamp=" + new Date().getTime()+"&&Pid=0&Sid=1",type: "get",dataType: "json",
            success: function(b) {
            	console.debug(b);
                if(0 == b.code){
