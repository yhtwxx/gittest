			...
			<div class="game-box multi-locate-order" style="display: block;">
				<table id="FIRST2" class="choose-group-block">
					<tbody>
						<tr>
							<th rowspan="3">
								<table class="choose-group-table">
									<tbody>
										<tr>
											<td class="choose-group-name">前2</td>
											<td class="odds-box">
												<table>
													<tbody>
														<tr class="odds-item">
															<td>中2 <span class="odds" choose="FIRST:2:MATCH:2"
																id="odds_43001_1"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td>中1 <span class="odds" choose="FIRST:2:MATCH:1"
																id="odds_43001_2"></span>
															</td>
														</tr>
													</tbody>
												</table>
						...
						<tr>
							<td colspan="11" class="gold-input">下注金额 <input type="text"
								class="itemCode menu" value="" name="itemCode[]"
								data-itemcode="43001" data-itemNo="">
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table id="FIRST3" class="choose-group-block">
					<tbody>
						<tr>
							<th rowspan="4">
								<table class="choose-group-table">
									<tbody>
										<tr>
											<td class="choose-group-name">前3</td>
											<td class="odds-box">
												<table>
													<tbody>
														<tr class="odds-item">
															<td>中3 <span class="odds" choose="FIRST:3:MATCH:3"
																id="odds_43002_1"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td>中2 <span class="odds" choose="FIRST:3:MATCH:2"
																id="odds_43002_2"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td style="display: none;">中1 <span class="odds"
																choose="FIRST:3:MATCH:1" id="odds_43002_3"></span>
															</td>
														</tr>
													</tbody>
												</table>
						...
						<tr>
							<td colspan="11" class="gold-input">下注金额 <input type="text" id="menu"
								class="itemCode menu" value="" name="itemCode[]"
								data-itemcode="43002" data-itemNo="">
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table id="FIRST4" class="choose-group-block">
					<tbody>
						<tr>
							<th rowspan="5">
								<table class="choose-group-table">
									<tbody>
										<tr>
											<td class="choose-group-name">前4</td>
											<td class="odds-box">
												<table>
													<tbody>
														<tr class="odds-item">
															<td>中4 <span class="odds" choose="FIRST:4:MATCH:4"
																id="odds_43003_1"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td>中3 <span class="odds" choose="FIRST:4:MATCH:3"
																id="odds_43003_2"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td>中2 <span class="odds" choose="FIRST:4:MATCH:2"
																id="odds_43003_3"></span>
															</td>
														</tr>
														<tr class="odds-item">
															<td style="display: none;">中1 <span class="odds"
																choose="FIRST:4:MATCH:1">0.00</span>
															</td>
														</tr>
													</tbody>
												</table>
						...
						<tr>
							<td colspan="11" class="gold-input">下注金额 <input type="text" id="menu"
								class="itemCode menu" value="" name="itemCode[]"
								data-itemcode="43003" data-itemNo="">
...
<script src="${ctx}/js/lottery/bjsc/member_common_bjsc.js"
	type="text/javascript"></script>
<script src="${ctx}/js/lottery/bjsc/multilocate.choose.js"
	type="text/javascript"></script>
<script src="${ctx}/js/lottery/menu_util.js" type="text/javascript"></script>
<script type="application/javascript">
    //循环输出
    $.ajax({url: "${ctx}/bjsc/itemDate.do?timeStamp=" + new Date().getTime()+"&Pid=4",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
                var map = b.items_map;
                var key="43001";
