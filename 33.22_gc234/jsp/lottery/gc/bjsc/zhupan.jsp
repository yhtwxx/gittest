...
<script src="${ctx}/js/lottery/bjsc/member_common_bjsc.js" type="text/javascript"></script>
<script type="application/javascript">
    //循环输出
    $.ajax({url: "${ctx}/bjsc/itemDate.do?timeStamp=" + new Date().getTime()+"&Pid=1",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
