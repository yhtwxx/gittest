...
<script src="../js/lottery/lhc/lhc_zmt.js?51189" type="text/javascript"></script>
<script src="../js/lottery/Util.js" type="text/javascript"></script>
<script type="application/javascript">

    //循环输出
/*     $.ajax({url: "../lhc/getItem.do?timeStamp=" + new Date().getTime()+"&poolId=7",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
...
var itemInfo = "";
$.ajax({
	url: "../lhc/getItem.do?timeStamp=" + new Date().getTime()+"&poolId=7",
	type: "get",
	dataType: "json",
    success: function(b) {
    	itemInfo = b;
...
$.ajax({
	url: "../lhc/getDownRate.do?timeStamp=" + new Date().getTime()+"&poolId=7",
	type: "get",
	dataType: "json",
    success: function(b) {
    	//console.debug(b);
