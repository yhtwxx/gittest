                    ...
                    <div class="game-box" style="display: block;"><div class="tabs-box tabs-view-4">
                        ...
                        <div class="quick-bet">
                            ...
                            <div id="QuickMenu" class="display-area" style="display: none;">
                                <div>
                                	<label for="kxGold">下注金额 :</label>
                                	<span id="kxGoldBox">
	                                	<input class="itemCode" type="text" id="kxGold">
                                	</span>
                                </div>
                                ...
                                <fieldset>
							      	<legend>色波</legend>
						      		<p>
								        <a class="RED" onclick="getColorAll('R')">红波</a>
								        <a class="BLUE" onclick="getColorAll('B')">蓝波</a>
								        <a class="GREEN" onclick="getColorAll('G')">绿波</a>
						      		</p>
							    </fieldset>
							    <fieldset class="HB">
									<legend>半波</legend>
									<p>
										<a class="RED" onclick="getColorHerf('R','dan')">红单</a>
										<a class="RED" onclick="getColorHerf('R','shuang')">红双</a>
										<a class="RED" onclick="getColorHerf('R','da')">红大</a>
										<a class="RED" onclick="getColorHerf('R','xiao')">红小</a>
										<a class="BLUE" onclick="getColorHerf('B','dan')">蓝单</a>
										<a class="BLUE" onclick="getColorHerf('B','shuang')">蓝双</a>
										<a class="BLUE" onclick="getColorHerf('B','da')">蓝大</a>
										<a class="BLUE" onclick="getColorHerf('B','xiao')">蓝小</a>
										<a class="GREEN" onclick="getColorHerf('G','dan')">绿单</a>
										<a class="GREEN" onclick="getColorHerf('G','shuang')">绿双</a>
										<a class="GREEN" onclick="getColorHerf('G','da')">绿大</a>
										<a class="GREEN" onclick="getColorHerf('G','xiao')">绿小</a>
									</p>
							    </fieldset>
							    <fieldset>
									<legend>头</legend>
									<p>
									  <a onclick="getNumByHead('0')">0</a>
									  <a onclick="getNumByHead('1')">1</a>
									  <a onclick="getNumByHead('2')">2</a>
									  <a onclick="getNumByHead('3')">3</a>
									  <a onclick="getNumByHead('4')">4</a>
									</p>
								</fieldset>
								<fieldset>
									<legend>尾</legend>
									<p>
									  <a onclick="getNumByFoot('0')">0</a>
									  <a onclick="getNumByFoot('1')">1</a>
									  <a onclick="getNumByFoot('2')">2</a>
									  <a onclick="getNumByFoot('3')">3</a>
									  <a onclick="getNumByFoot('4')">4</a>
									  <a onclick="getNumByFoot('5')">5</a>
									  <a onclick="getNumByFoot('6')">6</a>
									  <a onclick="getNumByFoot('7')">7</a>
									  <a onclick="getNumByFoot('8')">8</a>
									  <a onclick="getNumByFoot('9')">9</a>
									</p>
								</fieldset>
								<fieldset class="SPA">
									<legend>生肖</legend>
									<p>
									  <a onclick="getNumByAnimal('鼠')">鼠</a>
									  <a onclick="getNumByAnimal('牛')">牛</a>
									  <a onclick="getNumByAnimal('虎')">虎</a>
									  <a onclick="getNumByAnimal('兔')">兔</a>
									  <a onclick="getNumByAnimal('龙')">龙</a>
									  <a onclick="getNumByAnimal('蛇')">蛇</a>
									  <a onclick="getNumByAnimal('马')">马</a>
									  <a onclick="getNumByAnimal('羊')">羊</a>
									  <a onclick="getNumByAnimal('猴')">猴</a>
									  <a onclick="getNumByAnimal('鸡')">鸡</a>
									  <a onclick="getNumByAnimal('狗')">狗</a>
									  <a onclick="getNumByAnimal('猪')">猪</a>
									</p>
								</fieldset>
...
<script type="text/template" id="contentTpl">
    <table class="order-table tabs-view" tabs-view="1" style="display: table;">
        ...
        <tbody><tr>
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode1"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="01">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode11"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="11">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode21"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="21">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode31"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="31">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode41"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="41">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode2"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="02">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode12"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="12">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode22"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="22">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode32"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="32">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode42"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="42">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode3"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="03">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode13"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="13">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode23"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="23">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode33"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="33">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode43"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="43">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode4"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="04">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode14"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="14">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode24"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="24">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode34"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="34">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode44"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="44">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode5"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="05">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode15"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="15">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode25"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="25">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode35"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="35">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode45"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="45">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode6"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="06">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode16"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="16">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode26"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="26">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode36"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="36">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode46"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="46">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode7"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="07">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode17"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="17">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode27"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="27">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode37"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="37">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode47"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="47">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode8"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="08">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode18"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="18">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode28"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="28">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode38"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="38">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode48"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="48">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode9"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="09">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode19"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="19">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode29"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="29">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode39"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="39">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode49"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="49">
            </td>
        </tr>
        <tr>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode10"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="10">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode20"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="20">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode30"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="30">
            </td>
            <td class="choose">
            ...
            <td class="choose">
                <span class="odds"><#=items_map[61005].odds.toFixed(2)#></span>
                <input type="text" id="itemCode40"  class="itemCode" value=""  name="itemCode[]" data-itemcode="61005" data-itemno="40">
            </td>
        </tr>
        </tbody></table>
...
<script type="application/javascript">
    ...
    //循环输出
 /*    $.ajax({url: "../lhc/getItem.do?timeStamp=" + new Date().getTime()+"&poolId=3,6",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
...
var itemInfo = "";
$.ajax({
	url: "../lhc/getItem.do?timeStamp=" + new Date().getTime()+"&poolId=3,6",
	type: "get",
	dataType: "json",
    success: function(b) {
    	itemInfo = b;
...
$.ajax({
	url: "../lhc/getDownRate.do?timeStamp=" + new Date().getTime()+"&poolId=3,6",
	type: "get",
	dataType: "json",
    success: function(b) {
    	//console.debug(b);
...
/* $(function () {
	sn_Lottery_choose("#scrollResults", ".scrollNum", 50, "15,42,02,08,27,31,09");
}); */
