...
<div class="pagemain">
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">
	        ...
	        <li role="presentation" class="active"><a href="abrecord.do"><spring:message code="public.BettingRecords.AB" /></a></li>
...
var endTime = $("#end").val();
var url = "abrecordJson.do?timeStamp=" + new Date().getTime()+"&toTime="+endTime+"&fromTime="+startTime;
var addhtml = '';
