	...
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">
	        <li role="presentation"><a href="record.do"><spring:message code="public.BettingRecords.lotteryGames" /></a></li>
	  		...
	  		<li role="presentation" class="active"><a href="ptrecord.do"><spring:message code="public.BettingRecords.PT" /></a></li>
		...
		<div class="search">
	        <form action="" datatype="html" call="recordSearch" target="_self">
	            <!-- <input id="start" name="date" class="laydate-icon" /> -->
...
<script type="text/template" id="contentTpl">
	...
	#>
		<tr class="text-c">
			<td><#=list[i].gamedateStr #></td>
            <td><#=list[i].gamename #></td>
			<td><#=list[i].gamecode #></td>
            <td><#=formatMoney(list[i].bet/100) #></td>
            <td><#=formatMoney(list[i].win/100) #></td>
			<td><#=formatMoney((list[i].win-list[i].bet)/100) #></td>
		</tr>
 	<#}#>
		<tr class="text-c">
...
var endTime = $("#end").val();
var url = "ptrecordJson.do?timeStamp=" + new Date().getTime() + "&fromTime=" + startTime + "&toTime=" + endTime;
var addhtml = '';
