...
<div class="pagemain">
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">        
	        ...
	        <li role="presentation" class="active"><a href="xtdrecord.do"><spring:message code="public.BettingRecords.XTD" /></a></li>
...
var endTime = $("#end").val();
var url = "xtdrecordJson.do?timeStamp=" + new Date().getTime()+"&toTime="+endTime+"&fromTime="+startTime;
var addhtml = '';
