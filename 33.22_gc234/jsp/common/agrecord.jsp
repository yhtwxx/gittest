...
<div class="pagemain">
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">
	        ...
	        <li role="presentation" class="active"><a href="agrecord.do"><spring:message code="public.BettingRecords.AG" /></a></li>
        ...
        <table width="100%" class="table_b">
			<thead>
				<tr class="table_b_th">
				    ...
				    <td><spring:message code="public.BettingRecords.LobbyNumber" /></td>
...
<script type="text/template" id="contentTpl">
	...
	#>
		<tr class="text-c">
                ...
                <td><#if(list[i].gametype=="BAC"){ #>
					<spring:message code="public.game.Baccarat" />
					<#}else if(list[i].gametype=="DT"){ #>
					<spring:message code="public.game.DragonAndTiger" />
					<#}else if(list[i].gametype=="SHB"){ #>
					<spring:message code="public.game.SicBo" />
					<#}else if(list[i].gametype=="ROU"){ #>
					<spring:message code="public.game.Roulette" />
					<#}else if(list[i].gametype=="FT"){ #>
					<spring:message code="public.game.Fantan" />
					<#}else if(list[i].gametype=="CBAC"){ #>
					<spring:message code="public.game.Baccarattable" />
					<#}else if(list[i].gametype=="LINK"){ #>
					<spring:message code="public.game.Baccaratchain" />
					<#}else if(list[i].gametype=="LBAC"){ #>
					<spring:message code="public.game.JingMiBaccarat" />
					<#}else{ #>
						<#=list[i].gametype #>
					<#}#>
				</td>
				<td><#=list[i].round #></td>
				<td><#=list[i].gamecode #></td>
				<td><#=list[i].tablecode #></td>
				<td><#=list[i].playtype #></td>
				<td><#=list[i].gameResult #></td>
                <td><#=formatMoney(list[i].betvalue/100) #></td>
				<td><#=formatMoney((list[i].payMoney-list[i].betvalue)/100) #></td>
		</tr>
 	<#}#>
		<tr class="text-c">
...
var endTime = $("#end").val();
var url = "agrecordJson.do?timeStamp=" + new Date().getTime()+"&toTime="+endTime+"&fromTime="+startTime;
var addhtml = '';
