...
<div class="pagemain">
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">
	        ...
	        <li role="presentation" class="active"><a href="mgrecord.do"><spring:message code="public.BettingRecords.MG" /></a></li>
...
<script type="text/template" id="contentTpl">
	...
	#>
		<tr class="text-c">
				...
				<td><#=list[i].rowid #></td>
				<td><#=list[i].displaynamecategory #></td>
				<td><#=formatMoney(list[i].bet/100) #></td>
				<td><#=formatMoney((list[i].pay-list[i].bet)/100) #></td>
		</tr>
 	<#}}#>
		<tr class="text-c">
...
var endTime = $("#end").val();
var url = "${ctx }/mg/mgrecordJson.do?toTime="+endTime+"&fromTime="+startTime;
var addhtml = '';
