...
<div class="pagemain">
	<div class="navbar-fixed-top">
	    <ul class="nav nav-tabs my-nav">       
	        ...
	        <li role="presentation" class="active"><a href="imrecord.do"><spring:message code="public.BettingRecords.imSports" /></a></li>
    ...
    <div class="display biao-cont">
        <table width="100%" class=MMain>
			<thead>
				<tr class="table_b_th">
				    <td><spring:message code="public.BettingRecords.BettingTime" /></td>
				    <td><spring:message code="public.BettingRecords.PlayedTime" /></td>
				    <td><spring:message code="public.BettingRecords.Gameplay" /></td>
				    ...
				    <td><spring:message code="public.BettingRecords.BillingAmount" />(<spring:message code="public.currency.rmb" />)</td>
...
<script type="text/template" id="contentTpl">
	...
	#>
		<tr class="text-c">
			<td><#=list[i].bettimestr #></br><#=list[i].betid #></td>
			<td><#=list[i].matchdatetime #></td>
			<td><#=list[i].bettypechn #></td>
            <td align="left" valign="top"><#=list[i].html #></td>
			<td><#=formatMoney(list[i].betamt/100) #></td>
			<#if(list[i].settled=="0"){ #>
				<td></td>
				<td><spring:message code="public.BettingRecords.Status.going" /></td>
			<#}else if(list[i].settled=="1"){ #>
				<td><#=formatMoney(list[i].result/100) #></td>
				<td><spring:message code="public.BettingRecords.Status.AlreadyPrize" /></td>
			<#} #>
			<td align="left" valign="top"><#=list[i].matchresulthtml #></td>
		</tr>
 	<#}#>
		<tr class="text-c">
			<td></td>
...
var endTime = $("#end").val();
var url = "imrecordJson.do?timeStamp=" + new Date().getTime() + "&fromTime=" + startTime + "&toTime=" + endTime;
var addhtml = '';
