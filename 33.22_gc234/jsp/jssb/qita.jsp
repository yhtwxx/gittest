...
<script src="../js/lottery/jssb/member_common_jssb.js?51197755" type="text/javascript"></script>
<script src="../js/lottery/Util.js" type="text/javascript"></script>
<script type="application/javascript">

    //循环输出
    $.ajax({url: "../jssb/itemDate.do?timeStamp=" + new Date().getTime()+"+&Pid=3,4,5,6,7",type: "get",dataType: "json",
        success: function(b) {
            if(0 == b.code){
