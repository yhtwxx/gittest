...
<div class="card_main">
    <div class="card_width">
        <form action="${url }member/mobaopaybank.do" name="orderForm" id="orderForm">
                        ...
                        <div class="bz_bank">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="bankCode" id="radio24" value="CNCB"></td>
                                ...
                                <tr>
									...
									<td><input type="radio" name="bankCode" id="radio18" value="PAB"></td>
