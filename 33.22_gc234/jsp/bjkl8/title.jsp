...
<div class="caiplay">
	<ul class="nav nav-pills" role="tablist">
		<li role="presentation" class="active"><a href="${ctx}/bjkl8/xuanhao.do" target="caiplay">选号</a></li>
		<li role="presentation"><a href="${ctx}/bjkl8/qita.do" target="caiplay">其他</a></li>
	</ul> <!-- /pills -->
</div>
