...
<div class="caiplay">
	<ul class="nav nav-pills" role="tablist">
		<li role="presentation" class="active"><a href="${ctx}/bjsc/zhupan.do" target="caiplay">主盘势</a></li>
		<li role="presentation"><a href="${ctx}/bjsc/dingwei.do" target="caiplay">定位</a></li>
		<li role="presentation"><a href="${ctx}/bjsc/guanya.do" target="caiplay">冠亚军和</a></li>
		<li role="presentation"><a href="${ctx}/bjsc/xuanhao.do" target="caiplay">选号</a></li>
	</ul> <!-- /pills -->
</div>
