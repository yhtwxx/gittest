...
<div class="caiplay">
	<ul class="nav nav-pills" role="tablist">
		<li role="presentation" class="active"><a href="${ctx}/gdsf/zhupan.do" target="caiplay">主盘势</a></li>
		<li role="presentation"><a href="${ctx}/gdsf/danma.do" target="caiplay">单码双面</a></li>
		<li role="presentation"><a href="${ctx}/gdsf/siji.do" target="caiplay">四季五行</a></li>
		<li role="presentation"><a href="${ctx}/gdsf/fangwei.do" target="caiplay">方位/中发白</a></li>
		<li role="presentation"><a href="${ctx}/gdsf/zonghe.do" target="caiplay">总和/龙虎</a></li>
		<li role="presentation"><a href="${ctx}/gdsf/yizhong.do" target="caiplay">一中一</a></li>
	</ul> <!-- /pills -->
</div>
