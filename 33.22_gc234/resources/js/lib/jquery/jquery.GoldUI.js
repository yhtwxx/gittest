(function (namespace) {
    ...
    namespace.GoldUI = function () {
        ...
        if (_config.loadCookie) {
            try {
                var quickGold = eval(_getCookie('GoldCatch'));
            ...
            self.GoldUI.setConfig({disabeleGold: _disabeleGold});
        ...
        //籌碼高度
        var _total = _gold.length, _height = 100;
        (_total == 5) && (_height = 80);
        (_total == 6) && (_height = 65);
        (_total == 7) && (_height = 55);
        (_total == 8) && (_height = 50);
    ...
    namespace.GoldUI.prototype = {
         ...
         * @param inp input
         */
        menuCallback : function (id, gold, inp) {
           if (typeof _handle[id] != 'undefined' && _handle[id] instanceof Function) {
               var func = _handle[id];
               func(gold, inp);
           }
        },
        ...
        onMenuClick : function () {
            ...
            if (_focus) {
                ...
                var id = _focus.getAttribute('data-callback-id');
                _ui.menuCallback(id, this.x, _focus);
                _focus = null;
            }
        },
        /**
        ...
        onSelectChang : function () {
            ...
            if (_focus) {
                ...
                (_focus.onkeyup) && _focus.onkeyup();
                var id = _focus.getAttribute('data-callback-id');
                _ui.menuCallback(id, this.value, _focus);
                _focus = null;
            }
        },
        /**
        ...
        onGoldFocus : function (_input) {
            ...
            if (_input.value != '') {
                ...
                _timeout = setTimeout(function () {_input.select();},50);
            }
            if (_config.mobile) {
                ...
                _focus = _input;
                var _pos = _getOffsetPos(_input), overflow = false;
                //menu 位置
                if (_config.menuDir == 'top') {
                    ...
                    (_left + this.menu.offsetWidth > winWidth) && (overflow = true); 
                } 
                if (_config.menuDir != 'top' || overflow) {
        ...
        onDragEnd : function (e) {
            ...
            if (_onDrag) {
                ...
                this.mask.style.display = 'none';
                (this.carNode) && (this.carNode.parentNode) && (this.carNode.parentNode.className = this.dragBox.className);
        ...
        if (_selector instanceof jQuery) {
            ...
            _selector.each(function () {
                if (this.tagName.toUpperCase() == 'INPUT' && (this.type.toUpperCase() == 'NUMBER' || this.type.toUpperCase() == 'TEXT')) {
                    ...
                    this.setAttribute('data-callback-id', _id);
                }
            });
            _id++;
        }
