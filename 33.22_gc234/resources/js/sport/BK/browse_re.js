...
var code='';
var pg=0;
var uid='ct36h19asm13706722l4158707';
var loading = 'Y';
var loading_var = 'Y';
var ShowType = '';
var ltype = '3';
	...
	*/
	...
	if (ObjDataFT[gamerec].isMaster=="Y"){
		...
		if(top.langx!="en-us" ){
			...
			else if(se_now.charAt(0)=="H"){
				str_se_now=top.str_BK_MS[se_now.charAt(1)*1];
			}
			else {
			...
			else if(se_now=="HT")str_se_now= "Half Time";
...
function parseUrl(uid,odd_f_type,betTeam,GameData,gamerec,wtype){
	...
	var ret="<a href='javascript://' onclick=\"parent.parent.mem_order.betOrder('BK','"+rewtype[wtype]+"','"+param+"');\" title='"+team+"'><font "+check_ioratio(gamerec,tmp_rtype,GameData)+">"+ioratio+"</font></a>";
