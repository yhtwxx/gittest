...
//	}
	...
	//全場
	//單雙
	onelayer=onelayer.replace("*RATIO_ODD*",parseUrl(odd_f_type,"ODD",ObjDataFT[gamerec],gamerec,"T"));
	onelayer=onelayer.replace("*RATIO_EVEN*",parseUrl(odd_f_type,"EVEN",ObjDataFT[gamerec],gamerec,"T"));
	//入球數
	onelayer=onelayer.replace("*RATIO_T01*",parseUrl(odd_f_type,"T01",ObjDataFT[gamerec],gamerec,"T"));
	onelayer=onelayer.replace("*RATIO_T23*",parseUrl(odd_f_type,"T23",ObjDataFT[gamerec],gamerec,"T"));
	onelayer=onelayer.replace("*RATIO_T46*",parseUrl(odd_f_type,"T46",ObjDataFT[gamerec],gamerec,"T"));
	onelayer=onelayer.replace("*RATIO_OVER*",parseUrl(odd_f_type,"OVER",ObjDataFT[gamerec],gamerec,"T"));
...
function getParam(odd_f_type,rtype,wtype,GameData){
	...
	paramArray['T']=new Array("gid","odd_f_type","rtype","langx");
	var param="";
