...
//	}
	...
	//全場
	//半全場
	onelayer=onelayer.replace("*RATIO_FHH*",parseUrl(odd_f_type,"FHH",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FHN*",parseUrl(odd_f_type,"FHN",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FHC*",parseUrl(odd_f_type,"FHC",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FNH*",parseUrl(odd_f_type,"FNH",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FNN*",parseUrl(odd_f_type,"FNN",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FNC*",parseUrl(odd_f_type,"FNC",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FCH*",parseUrl(odd_f_type,"FCH",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FCN*",parseUrl(odd_f_type,"FCN",ObjDataFT[gamerec],gamerec,"F"));
	onelayer=onelayer.replace("*RATIO_FCC*",parseUrl(odd_f_type,"FCC",ObjDataFT[gamerec],gamerec,"F"));
...
function getParam(odd_f_type,rtype,wtype,GameData){
	...
	paramArray['F']=new Array("gid","odd_f_type","rtype","langx");
