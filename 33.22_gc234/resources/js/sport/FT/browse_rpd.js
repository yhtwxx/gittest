...
//	}
	...
	//全場
	//波膽
	onelayer=onelayer.replace("*RATIO_H1C0*",parseUrl(odd_f_type,"RH1C0",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H2C0*",parseUrl(odd_f_type,"RH2C0",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H2C1*",parseUrl(odd_f_type,"RH2C1",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H3C0*",parseUrl(odd_f_type,"RH3C0",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H3C1*",parseUrl(odd_f_type,"RH3C1",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H3C2*",parseUrl(odd_f_type,"RH3C2",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H4C0*",parseUrl(odd_f_type,"RH4C0",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H4C1*",parseUrl(odd_f_type,"RH4C1",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H4C2*",parseUrl(odd_f_type,"RH4C2",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H4C3*",parseUrl(odd_f_type,"RH4C3",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H0C0*",parseUrl(odd_f_type,"RH0C0",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H1C1*",parseUrl(odd_f_type,"RH1C1",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H2C2*",parseUrl(odd_f_type,"RH2C2",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H3C3*",parseUrl(odd_f_type,"RH3C3",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H4C4*",parseUrl(odd_f_type,"RH4C4",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_OVH*",parseUrl(odd_f_type,"ROVH",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H0C1*",parseUrl(odd_f_type,"RH0C1",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H0C2*",parseUrl(odd_f_type,"RH0C2",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H1C2*",parseUrl(odd_f_type,"RH1C2",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H0C3*",parseUrl(odd_f_type,"RH0C3",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H1C3*",parseUrl(odd_f_type,"RH1C3",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H2C3*",parseUrl(odd_f_type,"RH2C3",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H0C4*",parseUrl(odd_f_type,"RH0C4",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H1C4*",parseUrl(odd_f_type,"RH1C4",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H2C4*",parseUrl(odd_f_type,"RH2C4",ObjDataFT[gamerec],gamerec,"RPD"));
	onelayer=onelayer.replace("*RATIO_H3C4*",parseUrl(odd_f_type,"RH3C4",ObjDataFT[gamerec],gamerec,"RPD"));
...
function getParam(odd_f_type,rtype,wtype,GameData){
	...
	paramArray['RPD']=new Array("gid","odd_f_type","rtype","langx");
	paramArray['HRPD']=new Array("gid","odd_f_type","rtype","langx");
