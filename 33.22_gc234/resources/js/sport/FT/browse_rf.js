...
//	}
	...
	//全場
	//半全場
	onelayer=onelayer.replace("*RATIO_FHH*",parseUrl(odd_f_type,"RFHH",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FHN*",parseUrl(odd_f_type,"RFHN",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FHC*",parseUrl(odd_f_type,"RFHC",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FNH*",parseUrl(odd_f_type,"RFNH",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FNN*",parseUrl(odd_f_type,"RFNN",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FNC*",parseUrl(odd_f_type,"RFNC",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FCH*",parseUrl(odd_f_type,"RFCH",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FCN*",parseUrl(odd_f_type,"RFCN",ObjDataFT[gamerec],gamerec,"RF"));
	onelayer=onelayer.replace("*RATIO_FCC*",parseUrl(odd_f_type,"RFCC",ObjDataFT[gamerec],gamerec,"RF"));
...
function getParam(odd_f_type,rtype,wtype,GameData){
	...
	paramArray['RF']=new Array("gid","odd_f_type","rtype","langx");
