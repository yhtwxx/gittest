$(function() {
    ...
    //循环输出
    $.ajax({url: "/gxk3/road.do?timeStamp=" + new Date().getTime()+"&resultDate="+date,type: "get",dataType: "json",
        success: function (b) {
            if (0 == b.code) {
    ...
    function doAction(resultList,numW,numStr,type,typeStr){
        ...
        over=function (num) {return (num > 10)}
        ...
        for (var i=0;i<resultList.length;i++) {
            ...
            if(resultList[i].result){
                    ...
                    var valueInt = parseInt(numStrs[0], 10)+parseInt(numStrs[1], 10)+parseInt(numStrs[2], 10);
                    if(type=='odd'){
                        var is =odd(valueInt);
