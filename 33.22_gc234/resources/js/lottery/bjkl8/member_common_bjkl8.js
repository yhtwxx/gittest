...
function reset() {
	 ...
	 */
	$("#balls-block").find(".ball").removeClass('checked');
...
function getCountdown() {
	$.ajax({
		url : "/bjkl8/countdown.do?timeStamp=" + new Date().getTime(),
		type : "get",
		dataType : "json",
		success : function(b) {
			if (0 == b.code) {
...
var count_effective = function() {
	...
	var limit = (balls < per_bet_balls) ? 0 : factorial(balls, balls
			- per_bet_balls + 1)
			/ factorial(1, per_bet_balls);
